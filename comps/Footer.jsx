const Footer = () => {
  return (
    <div className=" mt-20 mx-4 text-center flex flex-col items-center">
      ...
      <p className=" font-semibold text-zinc-900 text-sm"> © 2022 TRX Headphones All rights reserverd </p>
      ...
      <nav className=" flex mt-2 mb-2">
        ...
        <svg className=" h-8 w-auto cursor-pointer" viewBox="0 0 24 24" strokeWidth="1.5"
          stroke="#2c3e50" fill="none" > <title> Demo </title>
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
