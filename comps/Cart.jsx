...
const Cart = () => {
  ...
  return (
   ...
   bg-gray-700 bg-opacity-50 w-full h-full fixed z-50 right-0 top-0"
    ...
    >
      <div
        className=" relative overflow-y-auto  float-right h-full transition-all duration-500
      bg-white w-full md:w-2/4 lg:w-2/5"
      >
        <div className=" fixed bg-green-600 h-10 flex items-center pl-1 sm:pl-4 w-full shadow-sm shadow-gray-400">
          <button
        ...
        <section className=" pt-8 pl-1 sm:pl-4">
          ...
          {cartItems.length < 1 && (
           ...
           text-lg bg-green-600 text-white mt-8 
          ...
          {cartItems.length >= 1 && (
            ...
            my-10 text-white bg-green-600 rounded-xl px-20 py-1"
                onClick={checkOut}
              >
                PAY WITH STRIPE
              </button>
